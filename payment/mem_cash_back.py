...
if __name__ == '__main__':
    Config.env="local"
    get_token('plat')
    # AresTerraCons.ENV=ENV.LOCAL
    # 会员返水记录
    # result = record(
    #     # cash_back_id='20180126014001818',
    #     start_time=datetime_timestamp_ms('2018-05-08 00:00:00'), end_time=datetime_timestamp_ms('2018-05-10 00:00:00'),
    #                 # type=1, account='Ctuiyong02',
    #                 )
    # print(result.text)
    # 会员返水管理返水明细
    result = details(account=None, type=None)
    print(result.text)

    # result = statistics_mem(startTime=1520784000000, endTime=1521388799000,
    #                         agentId=2371,
    #                         memberId=370915,
    #                         # lotteryIds='2'
    #                         )
